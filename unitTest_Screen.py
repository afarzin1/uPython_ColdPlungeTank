...
#OLED.text("LINE1",1,10,OLED.white)
#OLED.text("LINE2",1,27,OLED.white)
#OLED.text("LINE3",1,44,OLED.white)  

#OLED.line(10,10,10,0,OLED.white)
...
while True:
    ...
    if not keyB.value():
        ...
        if y > 0:
            y -= 1
    OLED.fill_rect(x,y,len,wid,OLED.white)
    OLED.show()
